...
- ✅ **Function App**: `func-irail-dev-b7m2sk` (Running)
...
- **Function App**: `func-irail-dev-b7m2sk`
- **Resource Group**: `rg-irail-dev-b7m2sk`
- **URL**: https://func-irail-dev-b7m2sk.azurewebsites.net
...
```
# Current deployment with suffix "b7m2sk"
Function App: func-irail-dev-b7m2sk
Resource Group: rg-irail-dev-b7m2sk
SQL Server: sql-irail-dev-b7m2sk
Storage Account: stiraildevb7m2sk
Key Vault: kv-irail-dev-b7m2sk
Data Factory: df-irail-data-zqlb95
URL: https://func-irail-dev-b7m2sk.azurewebsites.net
...
### Current Endpoints
- **Base URL**: https://func-irail-dev-b7m2sk.azurewebsites.net
- **Stations**: `/api/stations`
- **Departures**: `/api/departures?station=008892007`
- **Health**: `/api/health`
...
├── 🏗️  Resource Group: rg-irail-dev-b7m2sk
├── ⚡ Function App: func-irail-dev-b7m2sk (Y1 Consumption Plan)
├── 🗄️  SQL Server: sql-irail-dev-b7m2sk + sqldb-irail-dev
├── 📊 Data Factory: df-irail-data-zqlb95 (Auto data collection)
├── 💾 Storage Account: stiraildevb7m2sk
├── 🔐 Key Vault: kv-irail-dev-b7m2sk  
├── 📈 Application Insights: ai-irail-dev-b7m2sk
└── 📝 Log Analytics: law-irail-dev-b7m2sk
```

**Key Features:**
- ✅ **Cost-Effective**: Y1 plan (~€0 with Azure for Students)
...
3. **Registry**: `criraildevb7m2sk.azurecr.io`
...
RESOURCE_GROUP_NAME: rg-irail-dev-b7m2sk
AZURE_LOCATION: francecentral
CONTAINER_REGISTRY_NAME: criraildevb7m2sk
...
az functionapp show --name func-irail-dev-b7m2sk --resource-group rg-irail-dev-b7m2sk --query "state"

# Test Function endpoints
curl https://func-irail-dev-b7m2sk.azurewebsites.net/api/health
curl https://func-irail-dev-b7m2sk.azurewebsites.net/api/stations

# Check Data Factory pipeline status
az datafactory pipeline-run query-by-factory \
  --resource-group rg-irail-dev-b7m2sk \
  --factory-name adf-irail-dev-b7m2sk \
...
- **Function App**: `func-irail-dev-b7m2sk` - Running
- **Resource Group**: `rg-irail-dev-b7m2sk` - Active  
- **SQL Database**: `sqldb-irail-dev-b7m2sk` - Online
- **Data Factory**: `adf-irail-dev-b7m2sk` - Pipelines Scheduled
...
1. **Function App Endpoints**:
   - Health Check: `https://func-irail-dev-b7m2sk.azurewebsites.net/api/health`
   - Stations API: `https://func-irail-dev-b7m2sk.azurewebsites.net/api/stations`
   - Connections API: `https://func-irail-dev-b7m2sk.azurewebsites.net/api/connections`
   - Liveboard API: `https://func-irail-dev-b7m2sk.azurewebsites.net/api/liveboard`
